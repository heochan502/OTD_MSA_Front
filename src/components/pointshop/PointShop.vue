...
const allItems = ref([
  { id: 1, name: '커피 쿠폰', price: '4,500' }, 
  { id: 2, name: '기프티콘', price: '5,000' }, 
  { id: 3, name: '스타벅스 아메리카노', price: '5,000' },
  { id: 4, name: '커피 쿠폰', price: '4,500' }, 
  { id: 5, name: '기프티콘', price: '5,000' }, 
  { id: 6, name: '스타벅스 아메리카노', price: '5,000' },
  { id: 7, name: '커피 쿠폰', price: '4,500' }, 
  { id: 8, name: '기프티콘', price: '5,000' }, 
  { id: 9, name: '스타벅스 아메리카노', price: '5,000' },
  { id: 10, name: '커피 쿠폰', price: '4,500' }, 
  { id: 11, name: '기프티콘', price: '5,000' }, 
  { id: 12, name: '스타벅스 아메리카노', price: '5,000' },
]);
...
const searchList = computed(() =>
  filteredItems.value.map(item => item.name).slice(0, 5)
);
    ...
    <div class="pointshop-item" v-for="item in filteredItems" :key="item.id">
      ...
      <div class="item-details">
        ...
        <p class="item-price">Price: {{ item.price }} Points</p>
          <button
          class="b-button"
          :disabled="isPurchased(item.id) || (userPoints.value < parseInt(item.price.replace(/,/g, ''), 10))"
          @click="purchase(item)"
          >
