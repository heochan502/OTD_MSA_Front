...
const fetchRecentHistory = async () => {
  try {
    ...
    if (result) {
      ...
      console.log('방법 1 - result에서:', { missionComplete: missionComplete.length, dailyMission: dailyMission.length });
      ...
      console.log('방법 2 - data에서:', { missionComplete: missionComplete.length, dailyMission: dailyMission.length });
    }
    ...
    console.log('합쳐진 데이터 개수:', combined.length);
    ...
    console.log('최종 표시할 데이터:', recentHistory.value);
    console.log('===========================================');
