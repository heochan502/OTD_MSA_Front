...
<template>
  <div class="user-detail">
    <v-card>
      ...
      <input type="text" v-model="point"></input>

      <v-card-subtitle>보유 경험치</v-card-subtitle>
      <input type="text" v-model="xp"></input>

      <v-card-subtitle>권한</v-card-subtitle>
      <v-select v-if="state.userInfo.userRoles != null" :items="['USER', 'SOCAIL', 'MANAGER', 'ADMIN']" v-model="state.userInfo.userRoles">{{ state.userInfo.userRoles}}</v-select>
